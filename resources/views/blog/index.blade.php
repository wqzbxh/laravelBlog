...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('res') }}/layui/css/layui.css">
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('res') }}/css/main.css">
    <!--加载meta IE兼容文件-->
    <!--[if lt IE 9]>
...
<div class="header">
    ...
    <div class="nav">
        <a href="index.blade.php" class="active">文章</a>
...
<div class="banner">
    <div class="cont w1000">
        <div class="title">
            <h3><br />Article</h3>
            <h4>person Marketing</h4>
        </div>
        <div class="amount">
            <p><span class="text">福亮</span><span class="access">个人营销</span></p>
        </div>
    </div>
</div>
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs12 layui-col-sm8 layui-col-md7">
                            <div class="item-cont">
                                ...
                                <a href="blog_details.blade.php" class="go-icon"></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs12 layui-col-sm8 layui-col-md7">
                            <div class="item-cont">
                                ...
                                <h5>设计文章11</h5>
                                <p>室内设计作为一门新兴的学科，尽管还只是近数十年的事，但是人们有意识地对自己生活、生产活动的室内进行安排布置，甚至美化装饰，赋予室内环境以所祈使的气氛，却早巳从人类文明伊始的时期就已存在</p>
                                <a href="{{url('/blog_details')}}" class="go-icon"></a>
                            </div>
                        </div>
                    </div>
                </div>
